...
namespace CalculadoraSalario.Tests
{
    public class CustomersServiceTests
    {
        ...
        public async Task GetCustomerAsync_CustomerExists_ReturnsCustomerDto()
        {
            ...
            var customer = new Customer(1, "João", "joao@gmail.com", "1234567890");
            var customerDto = new CustomerDto( "João", "joao@gmail.com", "1234567890",null);
        ...
        public async Task CreateAsync_CustomerDoesNotExist_AddsCustomer()
        {
            ...
            var createCustomerDto = new CreateCustomerDto("João", new object(), "joao@gmail.com", "1234567890");
            var customer = new Customer(0, "João", "joao@gmail.com", "1234567890");
        ...
        public async Task CreateAsync_CustomerAlreadyExists_ThrowsConflictException()
        {
            ...
            var createCustomerDto = new CreateCustomerDto("João", new object(), "joao@gmail.com", "1234567890");
            var existingCustomer = new Customer(1, "João", "joao@gmail.com", "1234567890");
            var customer = new Customer(0, "João", "joao@gmail.com", "1234567890");
        ...
        public async Task UpdateAsync_CustomerExists_UpdatesCustomer()
        {
            ...
            var updateCustomerDto = new CreateCustomerDto("João Updated", "João Updated", "joaozinho@gmail.com", "0987654321");
            var existingCustomer = new Customer(1, "João", "joao@gmail.com", "1234567890");
            _mockCustomersRepository.Setup(repo => repo.GetByIdAsync(1))
                .ReturnsAsync(existingCustomer);
            ...
            Assert.Equal("João Updated", existingCustomer.Name);
            Assert.Equal("joaozinho@gmail.com", existingCustomer.Email);
        ...
        public async Task UpdateAsync_CustomerNotFound_ThrowsNotFoundException()
        {
            ...
            var updateCustomerDto = new CreateCustomerDto("João Updated", "João Updated", "joaozinho@gmail.com" +
                "", "0987654321");
            _mockCustomersRepository.Setup(repo => repo.GetByIdAsync(1))
                .ReturnsAsync((Customer)null);
